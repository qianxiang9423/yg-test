...
;(function (window,$,ViewT){
    ...
    const Message = {
        ...
        _createContent: function($msg,conf){
            ...
            var html = !conf.header && !conf.title && conf.icon ? conf.icon : '';
            html += conf.content;
        ...
        getContainer(conf){
            ...
            var $container = conf.parent ? $(conf.parent) : $('.vt-message-package');
