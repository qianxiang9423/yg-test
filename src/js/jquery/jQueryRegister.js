window.applte = (function($) {
    ...
    function require(f) {
        ...
        this.rules = {
            ...
            isCheckedName: function(a,c) {
                var reg = /^[\u4E00-\u9FA5]{2,6}$/;
                if(!reg.test(a)) {return c};
            },
            isCheckedCompanyName: function(a,c) {
                var reg = /^[\u4E00-\u9FA5]{2,15}$/;
                if(!reg.test(a)) {return c};
            },
    ...
    require.prototype = {
        _init: function(b) {
            ...
            // 实时监听input框的输入值验证
            $('input').on("input propertychange",function(a){
                d.formValidator($(this));
            }),
    ...
    j.test = function (a) {
        ...
        var d = this;
        require.prototype.formValidator(opt);
        // return
    };
